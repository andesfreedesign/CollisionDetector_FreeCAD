...
# This will allow it to work on any operating system
PATH_TO_ICONS = os.path.dirname(__file__)
...
`ViewObject.Proxy`, if FreeCAD runs in the Graphic mode.
    """
# Some lines were removed to adapt the code to the macro
...
if __name__ == "__main__":
    command = CollisionDetectorCommand()
    command.Activated()